...
class BankLink extends React.Component {
   ...
   */
  sendBankLinkText() {
    axios.post(SERVER_URL + 'bank-link-sms', {
  ...
  render() {
    ...
    let noMoreCards = <div style={{ paddingBottom: '450px' }} />;
      ...
      noMoreCards = (
        <div className='d-flex justify-content-center container text-left' style={styles.bankCard}>
          <div className='card-body' style={{ paddingBottom: '200px' }}>
            <h5 style={styles.sectionTitleNoMoreAccounts}>No other accounts you'd like to monitor?</h5>
            <h6 style={styles.noMoreSubtitle}>
              You're all set! Keeper will start monitoring your purchases and text you when tax write offs are recorded. Your monthly
              subscription starts after we've found you at least $100 in tax write offs.
            </h6>
          </div>
        </div>
      );
    ...
    return (
      <div style={styles.outerContainer} className='container'>
        ...
        <div className='col-8 container'>
          <p style={styles.sectionTitlePlaidFace}>Which accounts would you like to monitor?</p>
          <p style={styles.plaidfaceSubtitle}>Link all financial accounts used to make work-related purchases.</p>
